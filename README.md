...
for inference, so title/body coverage can be compared without printing commit text. Use
`--format json` when automation needs that fingerprint as a machine-readable field.
