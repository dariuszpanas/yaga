...
The command tree starts with ten deliberately separated groups:
...
non-shallow history because Git's shallow boundary can hide stored parents. Commit, change, tree,
and size selection reject legacy graft overlays, and replacement refs are disabled for all four.
